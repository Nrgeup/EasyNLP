...
file_a = 'create_eval_file.txt'
file_b = 'revise_eval_file.txt'
file_train = 'image_coco.txt'
file_test = 'test_coco.txt'

a = Bleu(test_text=file_a, real_text=file_train, gram=2)
a.get_bleu_fast()
