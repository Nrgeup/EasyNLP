...
class EncoderDecoder(nn.Module):
    ...
    def forward(self, src, tgt, src_mask, tgt_mask):
        ...
        logit = self.decode(latent, src_mask, tgt, tgt_mask)  # (batch_size, max_tgt_seq, d_model)
    ...
    def greedy_decode(self, latent, src_mask, max_len, start_id):
        '''
        ...
        for i in range(max_len - 1):
            ...
            out = self.decode(latent, src_mask,
                              to_var(ys), to_var(subsequent_mask(ys.size(1)).long()))
